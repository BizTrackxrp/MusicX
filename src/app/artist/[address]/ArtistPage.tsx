  ...
  return (
    <div className={`min-h-screen ${theme === 'dark' ? 'bg-black text-white' : 'bg-white text-black'}`}>
      ...
      <div className="fixed top-0 left-0 right-0 z-50 p-4">
        ...
        } backdrop-blur-xl rounded-2xl px-4 py-3 border ${
            ...
            <div className="flex flex-col md:flex-row items-start gap-6">
              ...
              <div className="flex-1 pt-4 md:pt-8">
                ...
                <div className="flex gap-8 mt-6">
                  ...
                  <div>
                    <p className={`text-3xl font-bold ${theme === 'dark' ? 'text-white' : 'text-black'}`}>
                      {releases.reduce((sum, r) => sum + r.soldEditions, 0)}
                    </p>
          ...
          <div className="mt-12">
            ...
            {releases.length === 0 ? (
              <div className={`flex flex-col items-center justify-center py-16 rounded-2xl border ${
                theme === 'dark' ? 'bg-zinc-900/50 border-zinc-800' : 'bg-white/50 border-zinc-200'
              } backdrop-blur-sm`}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {releases.map((release) => {
                  ...
                  return (
                    <div 
                      key={release.id} 
                      className={`rounded-2xl overflow-hidden border group cursor-pointer transition-all hover:scale-[1.02] hover:shadow-xl ${
                    ...
                    >
                      <div className="relative">
                        ...
                        <div className="absolute inset-0 bg-black/0 group-hover:bg-black/40 transition-colors flex items-center justify-center">
                          <button className="w-14 h-14 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transform scale-75 group-hover:scale-100 transition-all"
                            style={{ background: getAccentGradient() }}
                          >
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="font-bold" style={{ color: profile.gradientStart || profile.accentColor }}>
                        ...
                        <button 
                          className="w-full mt-4 py-2.5 rounded-xl text-white font-semibold transition-all hover:opacity-90"
                          style={{ background: getAccentGradient() }}
                        >
                          Buy Now
                        </button>
                  ...
                  release.tracks.map((track, ti) => (
                    <div
                      ...
                      className={`flex items-center gap-4 p-4 transition-colors cursor-pointer group ${
                        theme === 'dark' ? 'hover:bg-zinc-800/50' : 'hover:bg-zinc-100/50'
                      } ${ri !== releases.length - 1 || ti !== release.tracks.length - 1 ? (
                        theme === 'dark' ? 'border-b border-zinc-800/50' : 'border-b border-zinc-200/50'
                      ) : ''}`}
                    >
                      <div className="relative">
